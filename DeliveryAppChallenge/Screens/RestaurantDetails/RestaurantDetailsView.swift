...
extension RestaurantDetailsView {
    ...
    func configureConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            menuListView.heightAnchor.constraint(equalToConstant: MenuCellView.cellSize * 11)
...
extension RestaurantDetailsView {
    func setup(_ restaurant: RestaurantDetails) {
        restaurantInfoView.setup(restaurant: restaurant)
